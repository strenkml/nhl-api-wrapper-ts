...
export interface IStandingsNowOutput_standings_placeName {
  default: string;
  fr?: string;
}
export interface IStandingsNowOutput_standings_teamName {
  default: string;
  fr: string;
}
export interface IStandingsNowOutput_standings_teamAbbrev {
  default: string;
}

export interface IStandingsNowOutput_standings {
  ...
  losses: number;
  otLosses: number;
  placeName: IStandingsNowOutput_standings_placeName;
  pointPctg: number;
  points: number;
  ...
  streakCode: string;
  streakCount: number;
  teamName: IStandingsNowOutput_standings_teamName;
  teamCommonName: IStandingsNowOutput_standings_placeName;
  teamAbbrev: IStandingsNowOutput_standings_teamAbbrev;
  teamLogo: string;
  ties: number;
...
export interface IStandingsNowOutput {
  wildCardIndicator: boolean;
  standings: IStandingsNowOutput_standings[];
}
