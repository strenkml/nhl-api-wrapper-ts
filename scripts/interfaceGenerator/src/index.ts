...
async function main() {
  ...
  // Get Team Stats
  const statsTeamStatsUrl1 = "https://api.nhle.com/stats/rest/en/team/summary?sort=shotsForPerGame&cayenneExp=seasonId=20232024%20and%20gameTypeId=2";
  const statsTeamStatsData1 = await getRequest(statsTeamStatsUrl1);

  const statsTeamStatsUrl2 = "https://api.nhle.com/stats/rest/en/team/summary?sort=goalsForPerGame&cayenneExp=seasonId=20222023%20and%20gameTypeId=2";
